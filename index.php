    ...
    <body>
        <div id="form-bg" style="">
            <form role="form" action="sc.php" method="post" id="send_form" class="well">
                <h4 style="text-align: center;margin-top: 0 !important;">给我发一个微信留言</h4><h6 style="text-align: center;margin-top: -0 !important;color:#ababab;">Send Me a WeChat Message</h6>
                <div class="form-group">
                    <label for="text">消息标题</label>  <label style="color:#ababab;" for="text">Message title</label>
                ...
                <div class="form-group">
                    <label for="contact">联系邮箱</label>  <label style="color:#ababab;" for="text">Emial</label>
                ...
                <div class="form-group">
                    <label for="desp">消息内容</label>  <label style="color:#ababab;" for="text">Message content</label>
                    <textarea class="form-control" id="desp" row="3" placeholder="消息内容，最长64K，选填，支持MarkDown" name="desp"></textarea>
                </div>
                <button type="submit" id="submit-btn" class="btn btn-primary">发送消息 / Send</button>
                <button type="reset" class="btn btn-primary" onclick="$('input').val('');$('textarea').html('')">　重置 / Reset　</button>
            </form>
        </div>
